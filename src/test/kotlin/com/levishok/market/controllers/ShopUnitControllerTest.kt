...
//    private val importRequestBodies = listOf(
//        // 1
//        """{
//                "items": [
//                    {
...
//    )
    ...
    fun importsReturns200() {
        for ((i, body) in importRequestBodies.withIndex()) {
            ...
            assertEquals(200, statusCode) { "part #$i: expected code 200, actual code $statusCode" }
        }
    }
    ...
    fun getReturns200() {
        ...
        for (body in importRequestBodies) {
            post("/imports")
                .contentType(MediaType.APPLICATION_JSON)
                .content(body)
                .let(mockMvc::perform)
